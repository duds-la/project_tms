<template>
    <div class="" data-twe-input-wrapper-init data-twe-input-group-ref>
        <form @submit.prevent="submit" class="max-w-md mx-auto">
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search"
                    ...
                    placeholder="Pesquise pela Transportadora..." name="name" v-model="form.name"/>
                <button type="submit"
...
function submit() {
    router.get('/carrier/search-by-name', form)
}
</script>
